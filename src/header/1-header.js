...
// document.querySelector('.navbar__content a').addEventListener('click',  function (e) {

// });

// Listener on buttons "Make-request"
document.querySelectorAll('a.make-request').forEach((el)=>{
